...
do
    ...
    do
        echo -n "$i " >> $file
        /home/dominik/.CLion12/system/cmake/generated/8fe85d49/8fe85d49/Debug/knapgen -n $numThings -N $numInsts -m $ratio -k $exp -d $balance -C $i -W $maxWeight -I 1000 1> myinst.dat 2> knapgenerrs
